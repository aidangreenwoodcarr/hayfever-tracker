  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // This assumes the mock data always has the same values
        if (
          data.length === 4 &&
          data[0].value === 4.2 &&
          data[1].value === 3.1
    ...
    <div className="space-y-4">
      ...
      {usingMockData && (
        <Alert>
          ...
          <AlertDescription>
            We're currently showing sample pollen data. Please allow location
            access to get real forecasts.
          </AlertDescription>
        </Alert>
      )}
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <Progress value={(overallLevel.value / 5) * 100} variant="pollen" className="h-2" />
        </div>
        ...
        <div className="space-y-4">
          {pollenData.map((item) => (
            ...
            >
              ...
              <Progress value={(item.value / 5) * 100} variant="pollen" className="h-2" />
