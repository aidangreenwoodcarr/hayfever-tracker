...
export default function GoogleMapsTest() {
  ...
  async function runTests() {
    ...
    if (!apiKey) {
      testResults.error = "No Google Maps API key found. Please add your API key to the environment variables."
    ...
    try {
      ...
      testResults.error = `Test failed: ${error instanceof Error ? error.message : String(error)}`
    }
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Test your Google Maps API configuration</CardDescription>
      </CardHeader>
      <CardContent>
        {isLoading ? (
          ...
          <div className="space-y-4">
            ...
            {!results.pollenApiWorks && (
              <Alert>
                ...
                <AlertDescription>
                  The Pollen API may not be enabled for your project. Make sure to enable the "Pollen API" in your
                  Google Cloud Console and ensure billing is set up. The app will fall back to sample data for pollen
                  information.
                </AlertDescription>
              </Alert>
            )}
